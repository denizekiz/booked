function Registration()
{
	var elements = {
		form:$('#frmRegister'),
		trainingType:$('select.customAttribute:first'),
		trainingLevel:$('select.customAttribute:last')
	};
	...
	Registration.prototype.init = function ()
	{
		...
		elements.trainingType.prop("selectedIndex", 1);
		elements.trainingLevel.prop("selectedIndex", 1);
		elements.trainingLevel.hide();
		$('label.customAttribute:last').hide();
