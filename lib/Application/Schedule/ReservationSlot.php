...
class ReservationSlot implements IReservationSlot
{
	...
	protected $_participantNumber;

	protected $_participantNames;

	protected $_inviteeNames;
	...
	public function getInviteeNames()
	{

		return $this->_inviteeNames;
	}

//added bu Deniz Ekiz
	/**
	 *
	 * @return participant number (int)
	 */
	...
	public function GetMaxParticipants()
{
	...
	//added by deniz ekiz
 public function IsSameTrainingType(UserSession $session)
	{
		$reservationType = $this->_reservation->GetAttributeValue(13);

		$userId = $session->UserId;
		$userRepository = new UserRepository();
		$user = $userRepository->LoadById($userId);
		$userTrainingType = $user->GetAttributeValue(15);
