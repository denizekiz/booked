...
<div class="customAttributes" {if !$IsAdmin} hidden {/if}>
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        var attributeValues = {
            trainingLevel:'{$UserAttributes['traininglevel']}',
            trainingType:'{$UserAttributes['trainingtype']}'
        };
