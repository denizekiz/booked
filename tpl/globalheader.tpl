...
<div id="wrapper">
	<div id="doc">
		...
		{*	<li class="menubaritem"><a href="{$Path}{Pages::SCHEDULE|cat:'?sd='}">{translate key="Schedule"}</a> **}
					{if $CanViewAdmin}
						<ul>
				...
				<li class="menubaritem"><a href="{$Path}{Pages::PAYMENT}">{translate key="Payment"}</a></li>
