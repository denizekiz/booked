...
interface IManageReservationsPage extends IPageable, IActionPage
{
	...
	// Addition by Burak C. to show participant number in admin reservation management page
	public function GetReservationParticipants($reservationRefNum);
...
class ManageReservationsPage extends ActionPage implements IManageReservationsPage
{
	...
	// Addition by Burak C.
	public function GetReservationParticipants($reservationRefNum){
		$series = $this->presenter->SetParticipants($reservationRefNum);
