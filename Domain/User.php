...
class User
{
	...
	public function ChangeCustomAttribute($customAttributeId, $attributeValue)
	{
		if (array_key_exists($customAttributeId, $this->_attributeValues))
		{
			$newAttribute = new AttributeValue($customAttributeId, $attributeValue);
			$changedAttributes = $this->_attributeValues;
			$changedAttributes[$customAttributeId] = $newAttribute;
			$this->ChangeCustomAttributes($changedAttributes);
		}
	}
